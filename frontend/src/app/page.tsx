...
const LoginPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center bg-gradient-to-r from-blue-500 to-indigo-600 text-white p-4 md:p-8">
      {/* Container to limit content width */}
      <div className="w-full max-w-7xl mx-auto">
        {/* Header */}
        <div className="text-center mb-8 relative">
          <h1 className="text-2xl md:text-4xl font-bold">SWOT Simulation Game</h1>
          <p className="text-base md:text-lg mt-2">Welcome to the Finsimco SWOT Simulation Game</p>
        ...
        <div className="flex flex-col md:flex-row justify-center items-start gap-4 md:gap-8 h-full">
          {/* Login Form */}
          <div className="bg-white text-black p-6 rounded shadow-lg w-full md:w-[400px] justify-center flex flex-col my-auto md:min-h-[68.5vh]">
          ...
          <div className="bg-white/90 text-black p-6 rounded shadow-lg w-full md:w-[600px] max-h-[60vh] md:max-h-none overflow-y-auto">
            <h2 className="text-xl md:text-2xl font-bold mb-4 text-center">Game Mechanics</h2>
            <div className="space-y-4">
              <div>
                <h3 className="font-bold text-base md:text-lg text-blue-600">Stage 1: Analysis and Due Diligence</h3>
                <ul className="list-disc ml-4 text-xs md:text-sm space-y-2">
              ...
              <div>
                <h3 className="font-bold text-base md:text-lg text-blue-600">Stage 2: Structuring</h3>
                <ul className="list-disc ml-4 text-xs md:text-sm space-y-2">
              ...
              <div>
                <h3 className="font-bold text-base md:text-lg text-blue-600">Stage 3: Summary</h3>
                <ul className="list-disc ml-4 text-xs md:text-sm space-y-2">
              ...
              <div className="space-y-2 mt-4">
                ...
                <div className="p-2 bg-yellow-100 rounded">
                  <p className="text-xs md:text-sm text-yellow-800 flex items-center">
                    <FaInfoCircle className="mr-2 text-xl md:text-2xl" />
      ...
      {/* Toast Message */}
      {showToast && (
        <div className="fixed bottom-16 md:bottom-4 right-4 bg-red-400 text-white px-4 py-2 rounded shadow-lg text-sm">
          Please enter your name and select a team.
        </div>
      )}

      {/* Desktop Warning Banner - Only show on mobile */}
      <div className="fixed bottom-0 left-0 right-0 bg-red-100 border-t border-red-400 text-red-700 text-xs md:text-sm px-4 py-2 md:hidden">
        <div className="flex items-center justify-center text-center">
          <svg className="w-4 h-4 md:w-6 md:h-6 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
